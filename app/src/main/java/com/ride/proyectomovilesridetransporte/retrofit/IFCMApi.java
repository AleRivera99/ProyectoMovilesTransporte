...
public interface IFCMApi {
    ...
    @Headers({
            ...
            "Authorization:key=AAAAWX45EEk:APA91bEgC4fFFfFoJib_dRRSStaQ_bwSHuO63FRnKgdvRjXYU68Yit7FCFjN3DXs2PVjQyySQVLC3OdU2Yqu-IXumIsrNbm3B-olaqSwKAbYElTisNkbIFwig9pXDfboedMJMWNxhgPd"
    })
    @POST("fcm/send")
